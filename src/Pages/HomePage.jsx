...
const APP_ID="85ebe036"
const  APP_KEY="64574b5961f3a29acebf0a095db44f23"
function HomePage() {
  ...
  return  <div className=' bg-[#faf9fb] p-10 flex-1'>
    <div className='max-w-screen-lg mx-auto'>
      ...
      <form onSubmit={HandleSearchRecipe} >
        ...
        <label className='input shadow-md flex items-center gap' >
          <Search size={'24'}/>
      ...
      <p className='text-slate-500 font-semibold m1-1 my-2 text-sm tracking-tight '>
        Popular Recipes
      </p>
